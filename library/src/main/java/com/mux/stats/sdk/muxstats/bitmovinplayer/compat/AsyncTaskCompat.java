package com.mux.stats.sdk.muxstats.bitmovinplayer.compat;
...
public class AsyncTaskCompat {
    ...
    public static <Params, Progress, Result> AsyncTask<Params, Progress, Result> executeParallel(
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            com.mux.stats.sdk.muxstats.bitmovinplayer.compat.AsyncTaskCompatHoneycomb.executeParallel(task, params);
        } else {
